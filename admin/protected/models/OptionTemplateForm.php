<?php
class OptionTemplateForm extends CFormModel
{
	// database fields
	public $id=0; 
	public $name; 
	...
	{				
		...
		$columns = Html::getColumnsMaxLength(Tbl_TplProductOptionCategory::tableName());	
		...
		} else if (Tbl_TplProductOptionCategory::model()->count($criteria)) {
	...
	public function save()
	{
		...
		// edit or new
		if ($this->id) {
			$model = Tbl_TplProductOptionCategory::model()->findByPk($this->id);	
		} else {
			$model = new Tbl_TplProductOptionCategory;	
