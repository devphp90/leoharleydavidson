...
/**
 * This is the model class for table "tpl_product_bundled_product_category".
 *
 * The followings are the available columns in table 'tpl_product_bundled_product_category':
 * @property string $id
 ...
 */
class Tbl_TplProductBundledProductCategory extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TplProductOptionCategory the static model class
	 */
	...
	{
		return 'tpl_product_bundled_product_category';
	}
