 ...
 */
class Tbl_CustomFieldsOption extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tbl_custom_fields_option_description' => array(self::HAS_MANY, 'Tbl_CustomFieldsOptionDescription', 'id_custom_fields_option'),
		);
	}
