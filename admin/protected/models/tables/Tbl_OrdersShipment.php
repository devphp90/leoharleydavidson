...
/**
 * This is the model class for table "orders_shipment".
 *
 * The followings are the available columns in table 'orders_product_variant_description':
 * @property string $id
 ...
 */
class Tbl_OrdersShipment extends CActiveRecord
{
	/**
