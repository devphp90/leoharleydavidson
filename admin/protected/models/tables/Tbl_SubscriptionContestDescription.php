 ...
 *
 * The followings are the available columns in table 'tag_description':
 ...
 */
class Tbl_SubscriptionContestDescription extends CActiveRecord
{
	/**
	...
	{
		return 'subscription_contest_description';
	}
