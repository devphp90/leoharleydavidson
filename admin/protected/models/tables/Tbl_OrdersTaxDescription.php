...
/**
 * This is the model class for table "orders_tax_description".
 *
 * The followings are the available columns in table 'orders_tax_description':
 * @property string $id_orders_tax
 * @property string $id_orders
 * @property string $name
 */
class Tbl_OrdersTaxDescription extends CActiveRecord
{
	/**
