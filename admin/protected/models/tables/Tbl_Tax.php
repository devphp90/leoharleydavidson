 ...
 */
class Tbl_Tax extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			'getDescription' => array(
				'with' => array(
					'tbl_tax_description' => array(
						'on' => 'tbl_tax_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function rules()
	{
		...
		return array(
			/*
			array('code, tax_number, id_user_created, id_user_modified, date_created, date_modified', 'required'),
			array('code', 'length', 'max'=>10),
			array('tax_number', 'length', 'max'=>50),
			array('id_user_created, id_user_modified', 'length', 'max'=>11),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, code, tax_number, id_user_created, id_user_modified, date_created, date_modified', 'safe', 'on'=>'search'),
			*/
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tbl_tax_description' => array(self::HAS_MANY, 'Tbl_TaxDescription', 'id_tax'),			
		);
	}
