 ...
 */
class Tbl_ProductDownloadableFiles extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			'getDescription' => array(
				'with' => array(
					'tbl_product_downloadable_files_description' => array(
						'on' => 'tbl_product_downloadable_files_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_downloadable_files_description' => array(self::HAS_MANY, 'Tbl_ProductDownloadableFilesDescription', 'id_product_downloadable_files'),	
		);
	}
