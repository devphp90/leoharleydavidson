 ...
 *
 * The followings are the available columns in table 'product_combo':
 * @property string $id
 * @property string $id_product
 * @property string $id_product_combo 
 * @property string $id_combo_product
 * @property string $id_combo_product_variant
 * @property string $qty  
 * @property string $sort_order
 * @property string $displayed  
 */
class Tbl_ProductCombo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_combo' => array(self::HAS_MANY, 'Tbl_ProductCombo', 'id_product_combo'),	
		);
	}
