...
/**
 * This is the model class for table "tpl_product_variant_category".
 *
 * The followings are the available columns in table 'tpl_product_variant_category':
 * @property string $id
 ...
 */
class Tbl_TplProductVariantCategory extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TplProductVariantCategory the static model class
	 */
	...
	{
		return 'tpl_product_variant_category';
	}
