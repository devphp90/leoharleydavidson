 ...
 * @property integer $use_shipping_price
 * @property string $shipping_price
 * @property string $date_displayed
 * @property integer $active
 * @property string $id_template_product_variant
 * @property string $id_template_product_option
 * @property string $id_user_created
 * @property string $id_user_modified
 * @property string $date_created
 * @property string $date_modified
 */
class Tbl_Product extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_product_description' => array(
						'on' => 'tbl_product_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_description' => array(self::HAS_MANY, 'Tbl_ProductDescription', 'id_product'),	
			'tbl_product_image' => array(self::HAS_MANY, 'Tbl_ProductImage', 'id_product'),	
			'tbl_product_category' => array(self::HAS_MANY, 'Tbl_ProductCategory', 'id_product'),	
		);
	}
