...
/**
 * This is the model class for table "product_bundled_product_group_description".
 *
 * The followings are the available columns in table 'product_bundled_product_group_description':
 * @property string $id_product_bundled_product_group
 * @property string $language_code
 * @property string $name
 */
class Tbl_ProductBundledProductGroupDescription extends CActiveRecord
{
	/**
	...
	{
		return 'product_bundled_product_group_description';
	}
