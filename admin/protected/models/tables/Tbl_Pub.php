 ...
 */
class Tbl_Pub extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_pub_description' => array(
						'on' => 'tbl_pub_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_pub_description' => array(self::HAS_MANY, 'Tbl_PubDescription', 'id_pub'),
		);
	}
