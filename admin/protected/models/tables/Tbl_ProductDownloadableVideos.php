 ...
 */
class Tbl_ProductDownloadableVideos extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			'getDescription' => array(
				'with' => array(
					'tbl_product_downloadable_videos_description' => array(
						'on' => 'tbl_product_downloadable_videos_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	{
		return 'product_downloadable_videos';
	}
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_downloadable_videos_description' => array(self::HAS_MANY, 'Tbl_ProductDownloadableVideosDescription', 'id_product_downloadable_videos'),	
		);
	}
