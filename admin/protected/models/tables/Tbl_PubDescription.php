...
/**
 * This is the model class for table "pub_description".
 *
 * The followings are the available columns in table 'banner_description':
 * @property int $id_banner
 * @property string $language_code
 * @property string $url
 * @property tynyint $target_blank
 * @property string $image

 */
class Tbl_PubDescription extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TagDescription the static model class
	 */
