...
/**
 * This is the model class for table "tpl_tag_group".
 *
 * The followings are the available columns in table 'tpl_tag_group':
 * @property string $id
 ...
 */
class Tbl_TplTagGroup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TplTagGroup the static model class
	 */
