 ...
 */
class Tbl_SubscriptionContest extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_subscription_contest_description' => array(
						'on' => 'tbl_subscription_contest_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_subscription_contest_description' => array(self::HAS_MANY, 'Tbl_SubscriptionContestDescription', 'id_subscription_contest'),
		);
	}
