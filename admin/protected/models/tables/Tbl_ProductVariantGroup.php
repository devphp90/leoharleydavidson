...
/**
 * This is the model class for table "product_variant_group".
 *
 * The followings are the available columns in table 'product_variant_group':
 * @property string $id
 ...
 */
class Tbl_ProductVariantGroup extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return ProductVariantGroup the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_variant_group_description' => array(self::HAS_MANY, 'Tbl_ProductVariantGroupDescription', 'id_product_variant_group'),	
			'tbl_product_variant_group_option' => array(self::HAS_MANY, 'Tbl_ProductVariantGroupOption', 'id_product_variant_group'),	
		);
	}
