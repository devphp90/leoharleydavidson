 ...
 */
class Tbl_TaxRuleException extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tbl_tax_rule_exception_rate' => array(self::HAS_MANY, 'Tbl_TaxRuleExceptionRate', 'id_tax_rule_exception')
		);
	}
