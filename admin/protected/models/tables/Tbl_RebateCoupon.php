 ...
 */
class Tbl_RebateCoupon extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_rebate_coupon_description' => array(
						'on' => 'tbl_rebate_coupon_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_rebate_coupon_description' => array(self::HAS_MANY, 'Tbl_RebateCouponDescription', 'id_rebate_coupon'),
		);
	}
