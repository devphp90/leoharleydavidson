 ...
 * @property string $name
  * @property datetime $display_start_date
   * @property datetime $display_end_date
 ...
 */
class Tbl_Banner extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_banner_description' => array(
						'on' => 'tbl_banner_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_banner_description' => array(self::HAS_MANY, 'Tbl_BannerDescription', 'id_banner'),
		);
	}
