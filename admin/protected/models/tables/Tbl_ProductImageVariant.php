...
/**
 * This is the model class for table "product_image_variant".
 *
 * The followings are the available columns in table 'product_image_variant':
 * @property string $id
 * @property string $displayed_in_listing
 * @property string $id_user_created
 * @property string $date_created
 */
class Tbl_ProductImageVariant extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tbl_product_image_variant_image' => array(self::HAS_MANY, 'Tbl_ProductImageVariantImage', 'id_product_image_variant'),	
		);
	}
