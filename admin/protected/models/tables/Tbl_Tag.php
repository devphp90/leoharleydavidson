 ...
 */
class Tbl_Tag extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_tag_description' => array(
						'on' => 'tbl_tag_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_tag_description' => array(self::HAS_MANY, 'Tbl_TagDescription', 'id_tag'),
		);
	}
