 ...
 */
class Tbl_StateDescription extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('state_code, language_code, name', 'required'),
			array('state_code, language_code', 'length', 'max'=>2),
			array('name', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('state_code, language_code, name', 'safe', 'on'=>'search'),
		);
	}
