...
/**
 * This is the model class for table "product_image_variant_image".
 *
 * The followings are the available columns in table 'product_image_variant_image':
 * @property string $id
 * @property string $id_product_image_variant
 * @property string $original
 * @property string $filename
 * @property integer $force_crop
 ...
 */
class Tbl_ProductImageVariantImage extends CActiveRecord
{
	/**
	...
	{
		return 'product_image_variant_image';
	}
