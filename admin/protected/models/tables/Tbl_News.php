 ...
 */
class Tbl_News extends CActiveRecord
{
	/**
    ...
    public function scopes()
    {
        return array(
			...
			'getDescription' => array(
				'with' => array(
					'tbl_news_description' => array(
						'on' => 'tbl_news_description.language_code="'.Yii::app()->language.'"',
						'together' => true,
					),
				),		
			),				
	...
	public function relations()
	{
		...
		return array(
			'tbl_news_description' => array(self::HAS_MANY, 'Tbl_NewsDescription', 'id_news'),	
			'tbl_news_comments' => array(self::HAS_MANY, 'Tbl_NewsComments', 'id_news'),	
		);
	}
