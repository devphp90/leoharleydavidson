...
$("#page_title").html("").append("'.Yii::t('views/pub/index','LABEL_TITLE').'");
$("#how-to-link a").prop("title","/index.html?gestion_des_publicites.html");
...
tabs.list.grid.obj.setHeader("#master_checkbox,'.Yii::t('global','LABEL_NAME').','.Yii::t('views/pub/index','LABEL_PUB').','.Yii::t('views/pub/index','LABEL_COLUMN').','.Yii::t('views/pub/index','LABEL_PAGE').','.Yii::t('global','LABEL_START_DATE').','.Yii::t('global','LABEL_END_DATE').','.Yii::t('global','LABEL_ENABLED').'",null,["text-align:center",,,"text-align:center","text-align:center","text-align:center","text-align:center","text-align:center"]);


tabs.list.grid.obj.setInitWidthsP("5,20,15,10,10,15,15,10");
tabs.list.grid.obj.setColAlign("center,left,left,center,center,center,center,center");
...
tabs.list.grid.obj.enableDragAndDrop(true);
...
tabs.list.grid.obj.rowToDragElement=function(id){
...
tabs.list.grid.obj.attachEvent("onDrop", function(sId,tId,dId,sObj,tObj,sCol,tCol){
	var obj = this;
