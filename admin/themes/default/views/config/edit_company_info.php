...
edit.layout.og_form = [];
edit.layout.obj = new dhtmlXLayoutObject("company_info_layout", "1C");
...
$.ajax({
	url: "'.CController::createUrl('edit_company_info_options').'",
	type: "POST",
	beforeSend: function(){
	...
	switch (id) {
		case "save":	
			$.ajax({
				...
				type: "POST",
				data: $("#company_info_layout").serialize(),
				dataType: "json",
				beforeSend: function(){			
					// clear all errors					
					$("#company_info_layout span.error").html("");
					$("#company_info_layout *").removeClass("error");		
...
?>
<form id="company_info_layout" style="width:100%; height:100%; padding:0; margin:0;"></form>