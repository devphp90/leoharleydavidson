...
edit.layout.og_form = [];
edit.layout.obj = new dhtmlXLayoutObject("category_filters_layout", "1C");
...
$.ajax({
	url: "'.CController::createUrl('edit_category_filters_options').'",
	type: "POST",
	beforeSend: function(){
	...
	switch (id) {
		case "save":	
			$.ajax({
				...
				type: "POST",
				data: $("#category_filters_layout").serialize(),
				dataType: "json",
				beforeSend: function(){			
					// clear all errors					
					$("#category_filters_layout span.error").html("");
					$("#category_filters_layout *").removeClass("error");		
...
?>
<form id="category_filters_layout" style="width:100%; height:100%; padding:0; margin:0;"></form>