...
edit.layout.og_form = [];
edit.layout.obj = new dhtmlXLayoutObject("general_layout", "1C");
...
$.ajax({
	url: "'.CController::createUrl('edit_general_options').'",
	type: "POST",
	beforeSend: function(){
	...
	switch (id) {
		case "save":	
			$.ajax({
				...
				type: "POST",
				data: $("#general_layout").serialize(),
				dataType: "json",
				beforeSend: function(){			
					// clear all errors					
					$("#general_layout span.error").html("");
					$("#general_layout *").removeClass("error");		
...
?>
<form id="general_layout" style="width:100%; height:100%; padding:0; margin:0;"></form>