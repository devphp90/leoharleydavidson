...
edit.layout.og_form = [];
edit.layout.obj = new dhtmlXLayoutObject("social_network_layout", "1C");
...
$.ajax({
	url: "'.CController::createUrl('edit_social_network_options').'",
	type: "POST",
	beforeSend: function(){
	...
	switch (id) {
		case "save":	
			$.ajax({
				...
				type: "POST",
				data: $("#social_network_layout").serialize(),
				dataType: "json",
				beforeSend: function(){			
					// clear all errors					
					$("#social_network_layout span.error").html("");
					$("#social_network_layout *").removeClass("error");		
...
?>
<form id="social_network_layout" style="width:100%; height:100%; padding:0; margin:0;"></form>