...
$("#page_title").html("").append("'.Yii::t('views/export/index','LABEL_TITLE').'");
...
tabs.list.grid.obj.setHeader("#master_checkbox,'.Yii::t('global','LABEL_NAME').','.Yii::t('views/export/edit_options','LABEL_TYPE').'",null,["text-align:center",,]);
...
tabs.list.grid.obj._in_header_select_filter_custom_type=function select_filter_custom_type(tag,index,data){
	...
	tag.innerHTML="<select style=\"width:90%;font-size:8pt;font-family:Tahoma;\" class=\"hdr_custom_filters\"><option value=\"\"></option><option value=\"0\">'.Yii::t('views/export/edit_options','LABEL_TYPE_0').'</option></select>";	
