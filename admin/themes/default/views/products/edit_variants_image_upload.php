...
$script = '$(function(){
	...
	$("#'.$container.'_button").uploadify({
		...
		"uploader" : "'.CController::createUrl('upload_image_variant',array('id'=>$id)).'",
		"checkExisting" : false,
		...
		"onUploadSuccess" : function(file,data,response){
			if (data != "true") {				
				...
				'.$container.'.wins_image.tabs.obj.setCustomStyle("errors",null,null,"color:#FF0000;");
				'.$container.'.wins_image.tabs.errors.grid.obj.addRow(null,file.name+","+data,null);				
			}
		},
		"onQueueComplete" : function(stats){
			'.$container.'.wins_image.tabs.images.layout.B.dataview.load();
