...
<div style="width:100%; height:100%; overflow:auto;" class="div_<?php echo $container; ?>">	
    <div style="padding:10px;">	
		...
		tax_group.name ASC';
                ...
                <div class="row">
                    <strong><?php echo Yii::t('views/products/edit_info_options', 'LABEL_YEAR'); ?></strong><?php echo (isset($columns['year']) ? '&nbsp;<em>(' . Yii::t('global', 'LABEL_MAXLENGTH') . ' <span id="' . $container . '_year_maxlength">' . ($columns['year'] - strlen($model->year)) . '</span>)</em>' : ''); ?>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path . 'year'); ?><br />
                    <div>
                        <?php
                        echo CHtml::activeTextField($model, 'year', array('size' =>10, 'id' => $container . '_year', 'onkeyup' => 'rewrite_number($(this).attr("id"));'));
                        ?>
                        <br /><span id="<?php echo $container; ?>_year_errorMsg" class="error"></span>
                    </div>                
                </div>
                <div class="row">
                    <strong><?php echo Yii::t('views/products/edit_info_options', 'LABEL_MILEAGE'); ?></strong><?php echo (isset($columns['mileage']) ? '&nbsp;<em>(' . Yii::t('global', 'LABEL_MAXLENGTH') . ' <span id="' . $container . '_mileage_maxlength">' . ($columns['mileage'] - strlen($model->mileage)) . '</span>)</em>' : ''); ?>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path . 'mileage'); ?><br />
                    <div>
                        <?php
                        echo CHtml::activeTextField($model, 'mileage', array('size' => 10, 'id' => $container . '_mileage', 'onkeyup' => 'rewrite_number($(this).attr("id"));'));
                        ?>
                        <strong>km</strong>
                        <br /><span id="<?php echo $container; ?>_mileage_errorMsg" class="error"></span>
                    </div>                
                </div>
                <div class="row">
                    <strong><?php echo Yii::t('views/products/edit_info_options', 'LABEL_COLOR'); ?></strong><?php echo (isset($columns['color']) ? '&nbsp;<em>(' . Yii::t('global', 'LABEL_MAXLENGTH') . ' <span id="' . $container . '_color_maxlength">' . ($columns['color'] - strlen($model->color)) . '</span>)</em>' : ''); ?>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path . 'color'); ?><br />
                    <div>
                        <?php
                        echo CHtml::activeTextField($model, 'color', array('size' => 10, 'id' => $container . '_color', 'maxlength' => $columns['color']));
                        ?>
                        <br /><span id="<?php echo $container; ?>_color_errorMsg" class="error"></span>
                    </div>                
                </div>
                <hr />     
                <div class="row">
