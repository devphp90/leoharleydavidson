...
'.$containerObj.'.layout.A.toolbar.modify = function(current_id){
	name = current_id ? "'.Yii::t('global','LABEL_EDIT').' - Review from: "+'.$containerObj.'.layout.A.grid.obj.cellById(current_id,2).getValue() : "New Tag";
...
'.$containerObj.'.layout.A.grid.obj.setHeader("#master_checkbox,'.Yii::t('views/products/edit_reviews','LABEL_DATE_CREATED').','.Yii::t('views/products/edit_reviews','LABEL_CUSTOMER_NAME').','.Yii::t('views/products/edit_reviews','LABEL_REVIEW').','.Yii::t('views/products/edit_reviews','LABEL_BOUGHT').','.Yii::t('views/products/edit_reviews','LABEL_RATING').'", null, ["text-align:center",,,,"text-align:center",]);
...
'.$containerObj.'.layout.A.grid.obj.setInitWidthsP("4,15,20,41,10,10");
'.$containerObj.'.layout.A.grid.obj.setColAlign("center,left,left,left,center,left");
'.$containerObj.'.layout.A.grid.obj.setColSorting("na,na,server,na,na,na");
'.$containerObj.'.layout.A.grid.obj.enableResizing("false,false,true,true,false,false");
