...
<div style="padding:10px;">	
    <div class="row">
        <strong><?php echo Yii::t('views/orders/reset_downloadable_video_options','LABEL_NO_DAYS_EXPIRE');?></strong>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path.'no-days-expire'); ?><br />
        <div>
        <?php
    ...
    <div class="row">
        <strong><?php echo Yii::t('views/orders/reset_downloadable_video_options','LABEL_NO_DOWNLOADS');?></strong>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path.'no-downloads'); ?><br />
        <div>
        <?php
    ...
    <div class="row">
        <strong><?php echo Yii::t('views/orders/reset_downloadable_video_options','LABEL_CURRENT_NO_DOWNLOADS');?></strong>&nbsp;&nbsp;<?php echo Html::help_hint($help_hint_path.'no-downloads'); ?><br />
        <div>
        <?php
