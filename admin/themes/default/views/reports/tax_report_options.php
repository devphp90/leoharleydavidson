<?php 
$help_hint_path = '/statistics/reports/tax-report/';
?>
...
<div style="padding:10px;">	
    <div class="row" style="float:left; margin-right:10px;">
        ...
        <div>
        <input type="text" size="10" name="start_date" id="start_date" value="" class="datetimepicker" />
    ...
    <div class="row" style="float:left; margin-right:10px;">
        ...
        <div>
        <input type="text" size="10" name="end_date" id="end_date" value="" class="datetimepicker" />
...
$script = '
$(function(){
	$(".datetimepicker").datepicker({ dateFormat: "yy-mm-dd", changeYear: true });
	
	$("#btn-search").on("click",function(){
		layout.B.grid.obj.xmlOrigFileUrl = "'.CController::createUrl('xml_list_tax_report').'?start_date="+$("#start_date").val()+"&end_date="+$("#end_date").val();
